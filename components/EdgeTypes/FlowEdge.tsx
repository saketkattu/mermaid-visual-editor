        ...
        >
          {editing ? (
            <input
              ...
              placeholder="label…"
              className="text-xs px-2 py-0.5 rounded border border-blue-400 bg-white shadow-sm outline-none w-28 text-center focus-visible:ring-2 focus-visible:ring-blue-500"
            />
          ) : displayLabel ? (
            <span
